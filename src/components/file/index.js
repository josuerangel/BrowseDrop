...
class File extends Component {
  constructor(props) {
    ...
    let userCaption =
      this.props.caption !== undefined ? this.props.caption : {};
  ...
  setHiddenButtonDelete() {
    if (
      this.props.data.buttonDownloadAutoHide === false ||
      this.props.data.buttonDeleteAutoHide === false
    )
      return "";
  ...
  setDisabled() {
    if (this.props.data.noAction === true) return "upb__itembox__disabled";
  }
  render() {
    ...
    if (this.caption !== undefined) {
      modalInstance = (
        <Modal show={this.state.showModal} onHide={this.closeModal.bind(this)}>
          ...
          <Modal.Body>{this.caption.deleteFileBody}</Modal.Body>
          <Modal.Footer>
            <Button onClick={this.closeModal.bind(this)}>
              {this.caption.btnDeleteFileClose}
            </Button>
            <Button bsStyle="primary" onClick={this.sendDeleteFile.bind(this)}>
              {this.caption.btnDeleteFileSave}
            </Button>
          </Modal.Footer>
        </Modal>
      );
    ...
    const buttonTrash =
      this.props.data.type !== "directory" &&
      this.props.data.buttonDelete !== false ? (
        <div
          title={this.caption.tooltipButtonDelete}
          className={
            "upb__itembox__btnDelete__container " + this.setHiddenButtonDelete()
          }
    ...
    const buttonDownload =
      this.props.data.type === "directory" &&
      this.props.data.buttonDownload === true ? (
        <div
          title={this.caption.tooltipButtonDownload}
          className={
            "upb__itembox__btnDelete__container " + this.setHiddenButtonDelete()
          }
    ...
    return (
      <div
        className={
          "upb__itembox animated " + this.setAnimation() + this.setDisabled()
        }
      ...
      >
        ...
        <div className="upb__itembox__date">{this.props.data.date}</div>
        {buttonTrash}
        {buttonDownload}
        {modalInstance}
      </div>
