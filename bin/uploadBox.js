	  ...
	  _createClass(File, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        "div",
	        { className: "boxList__item--display" },
	        _react2.default.createElement(
	          "ul",
	          { className: "listInfoFile--display" },
	          _react2.default.createElement(
	            "li",
	            { className: "listInfoFileItem--display" },
	            _react2.default.createElement(
	              "a",
	              { href: this.props.data.urlDownload },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _File = __webpack_require__(179);

	var _File2 = _interopRequireDefault(_File);

	var _FileDragAndDrop = __webpack_require__(181);

	var _FileDragAndDrop2 = _interopRequireDefault(_FileDragAndDrop);
	...
	var Directory = function (_React$Component) {
	    ...
	    _createClass(Directory, [{
	        key: 'handleDrop',
	        value: function handleDrop(dataTransfer, event) {
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                null,
	                _react2.default.createElement(
	                    _FileDragAndDrop2.default,
	                    { onDrop: this.handleDrop.bind(this) },
	                    _react2.default.createElement(_File2.default, { data: this.props.data })
	                )
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Directory = __webpack_require__(180);
	...
	var UploadBox = function (_React$Component) {
	    _inherits(UploadBox, _React$Component);

	    function UploadBox() {
	        _classCallCheck(this, UploadBox);

	        var _this = _possibleConstructorReturn(this, (UploadBox.__proto__ || Object.getPrototypeOf(UploadBox)).call(this));
	    ...
	    _createClass(UploadBox, [{
	        ...
	        key: 'addFile',
	        value: function addFile(fileList, dir) {
	            console.log('addFile');
	        ...
	        key: 'setItemList',
	        value: function setItemList() {
	            var _this2 = this;

	            return this.state.items.map(function (item) {
	                return item.urlDownload !== undefined ? _react2.default.createElement(_File2.default, { data: item }) : _react2.default.createElement(_Directory2.default, { data: item, addFile: _this2.addFile.bind(_this2) });
	            });
	        }
	    }, {
	        key: 'render',
	...
	UploadBox.propTypes = {
	    ...
	    dataFilesAndDirs: _react2.default.PropTypes.array
	};
